...
class ImageHandler():
    ...
    def OpenImage(self, context: 'ImageContext') -> 'ImageContext':
    ...
    def LayoutHandler(self, context: 'ImageContext') -> 'ImageContext':
    ...
    def OCRHandler(self, context: 'ImageContext') -> 'ImageContext':
    ...
    def ImageSave(self, context: 'ImageContext') -> 'ImageContext':
    ...
    def MarkdownHandler(self, context: 'ImageContext') -> 'ImageContext':
