...
public class StatsPlugin implements IPluginAPI {
    private IDatabaseService db;
    private JEditorPane textPane = new JEditorPane();

    @Override public String getTabName() { return "Аналитика"; }
    
    @Override public void onInitialize(IDatabaseService db) { 
        this.db = db; 
    ...
    public void onExperimentSelected(int id) {
        ...
        // Генерация HTML (совместимый с JEditorPane)
        ...
        // Карточки лидеров
        html.append("<table width='100%' cellpadding='8' cellspacing='5' style='margin-bottom: 15px;'>");
        html.append("<tr>");
    ...
    // Вспомогательные методы для генерации HTML-ячеек
    ...
    @Override public JPanel getPanel() { 
        return new JPanel(new BorderLayout()) {{ add(new JScrollPane(textPane)); }}; 
    }
}